    ...
    return (
        <div className='services-container'>
            <div className='services-about'>
                <motion.h1 className="services-title" animate={{ x: 0 }} initial={{ x: -300 }}>Services:</motion.h1>
                <ul>
                    <br></br>
                    <br></br>
                    <br></br>
                    <motion.li className="services-list-item" animate={{ x: 0 }} initial={{ x: 300 }}>
                        <span animate={{ x: 0 }} initial={{ x: 100 }}>Building Performance Consulting</span>
                        <br></br>
